                        ...
                        child: GridView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return MTVCard(
                              ...
                              originalLanguage:
                                  _personWork.work[index].originalLanguage,
                              overview: _personWork.work[index].overview,
                              posterPath: _personWork.work[index].posterPath,
                              backdropPath:
                                  _personWork.work[index].backdropPath,
                              releaseDate: _personWork.work[index].releaseDate,
                              title: _personWork.work[index].title,
                              voteAverage: _personWork.work[index].voteAverage,
                            );
                          },
                        ),
                      ),
