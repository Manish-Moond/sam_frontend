...
//   int malId;
//   int members;
//   List<dynamic> openingThemes;
//   int popularity;
//   dynamic premiered;
//   List<Genre> producers;
//   int rank;
//   String rating;
//   Map<String, List<Genre>> related;
...
//         endingThemes: List<dynamic>.from(json["ending_themes"].map((x) => x)),
...
//         openingThemes: List<dynamic>.from(json["opening_themes"].map((x) => x)),
...
//         rank: json["rank"],
//         rating: json["rating"],
//         related: Map.from(json["related"]).map((k, v) =>
//             MapEntry<String, List<Genre>>(
//                 k, List<Genre>.from(v.map((x) => Genre.fromJson(x))))),
...
//         "rank": rank,
//         "rating": rating,
//         "related": Map.from(related).map((k, v) => MapEntry<String, dynamic>(
